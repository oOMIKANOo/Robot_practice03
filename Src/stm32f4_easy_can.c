...
void stm32f4_easy_can_init(CAN_HandleTypeDef *hcan, unsigned int default_acceptance_filter, unsigned int default_filter_mask)
{
    ...
    sFilterConfig.FilterIdHigh = default_acceptance_filter << 5;
    sFilterConfig.FilterIdLow = default_acceptance_filter << 5;
    sFilterConfig.FilterMaskIdHigh = default_filter_mask << 5;
    sFilterConfig.FilterMaskIdLow = default_filter_mask << 5;
...
//*********************************************************
//    stm32f4_easy_can_get_receive_message
//*********************************************************
//  [概要]
//    受信データ取得
//  [引数]
...
//*********************************************************
//    stm32f4_easy_can_transmit_message
//*********************************************************
//  [概要]
//    データ送信
//  [引数]
...
//*********************************************************
//    stm32f4_easy_can_interrupt_handler
//*********************************************************
//  [概要]
...
//    その中で書く．
//--------------------------------------------------------
__weak void stm32f4_easy_can_interrupt_handler(void)
{
	// デフォルトでは何もしない
    return;
}
